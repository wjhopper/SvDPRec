...
```{r collapsed_recovery_plots}
dif, fig.width=9fusion_SDT_recovered <- lapply(
...
names(diffusion_SDT_recovered) <- 1:length(diffusion_SDT_recovered)
...
names(rdiffusion_recovered) <- 1:length(rdiffusion_recovered)
