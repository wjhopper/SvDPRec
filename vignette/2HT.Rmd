...
```{r ROC_plot, results="asis", dependson="stan_model", fig.width=10, fig.height=10}

ROC <- ggplot(twoHT_stan_ROC_points,
              aes(x=FAR, y=HR, color=strength, shape=pOld)
              ) +
  geom_point(size=2) +
  geom_line(aes(linetype=type, group=strength),
...
```{r std_twoHT_ROC_avg_plot, fig.width=8, fig.height=8, dependson="std_2HT_fit"}
...
```{r std_twoHT_ROC_sub_plot, fig.width=10, fig.height=10, dependson="std_2HT_fit"}
...
```{r std_twoHT_ROC_pooled_plot, fig.width=8, fig.height=8, dependson="std_twoHT_ROC_pooled_predictions"}
